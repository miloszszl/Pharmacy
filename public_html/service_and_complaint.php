        ...
        <div class="col-sm-10 col-sm-offset-2" >
            ...
            <div class="row">
                ...
                <div class="col-sm-8 user_greeting_panel" >
                    <h2><b>Serwis i reklamacje</b></h2>
                    <p>Aby złożyć reklamację przejdź do zakładki kontakt i napisz do nas wiadomość opisującą przyczynę reklamacji, a my skontaktujemy się z Tobą.</p><br>
                    Jeśli nie wiesz gdzie znajduje się zakładka kontakt kliknik w <a href="contact_us.php" style="color:orange;">TEN LINK</a>.
                </div>
            </div> 
        </div>
    </div>
